...
<head>
    ...
    <body>  
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <button type="button" class="btn btn-primary m-1 float-right" data-toggle="modal" data-target="#addModal">
                        <i class="fa fa-plus"></i> Add New Material Type
                    </button>
                </div>
            </div><br>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="table-responsive" id="tblMaterialType">
                    ...
                    <div class="modal-body">
                        <form id="formCreate">
                            ...
                            <div class="form-group">
                                <label for="txtName">Material Type Name</label>
                                <input type="text" class="form-control" name="txtName"  placeholder="Enter Material Type" required>
                            </div>
            ...
            $("body").on("click", ".editBtn", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#edit-form-id").val(data.MaterialTypeID);
                        $("#txtName").val(data.Material_Name);
